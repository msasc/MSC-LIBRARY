...
/**
 * MariaDB implementation of the {@link DBMetaData} interface.
 * @author Miquel Sas
 */
public class MariaDBMetaData extends DBMetaData {
	 ...
	 */
	public MariaDBMetaData(DBEngine db) { super(db); }
	...
	public RecordSet getCatalogs() throws SQLException {
		...
		return readRecordSet(sql, DBMetaData.Catalog.fields());
	}
	 ...
	 */
	@Override
	public RecordSet getColumns(String catalog, String schema, String table, String column) throws SQLException {
		...
		return readRecordSet(sql, DBMetaData.Column.fields());
	}
	/**
	...
	public RecordSet getSchemas(String catalog, String schema) throws SQLException {
		...
		return readRecordSet(sql, DBMetaData.Schema.fields());
	}
	...
	public RecordSet getTables(String catalog, String schema, String table) throws SQLException {
		...
		return readRecordSet(sql, DBMetaData.Table.fields());
	}
