...
public class DBIterator {
	 ...
	 */
	public DBIterator(DBEngine db) { this.db = db; }
	 ...
	 */
	public void select(Select select) throws SQLException { select(select.toSQL(), select.getFields()); }
	/**
	 * Start a select.
	 * @param sql
	 * @param fields
	...
	public void select(String sql, FieldList fields) throws SQLException {
		if (!isClosed()) { throw new SQLException("Iterator is open"); }
		this.fields = fields;
	...
	public boolean hasNext() throws SQLException {
		if (isClosed()) { throw new SQLException("Iterator is closed"); }
	 ...
	 * @return A boolean.
	 */
	public boolean isClosed() { return cn == null && st == null && rs == null; }
}
