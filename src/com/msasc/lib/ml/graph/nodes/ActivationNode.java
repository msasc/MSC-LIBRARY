...
public class ActivationNode extends Node {
	...
	public static ActivationNode fromJSONObject(JSONObject obj) {
		...
		double flatSpot = obj.get("flat-spot").getDouble();
	...
	public void toJSONObject(JSONObject def) {
		def.put("activation", JSONTypes.STRING, activation.getClass().getSimpleName());
		def.put("flat-spot", JSONTypes.NUMBER, flatSpot);
	}
}
