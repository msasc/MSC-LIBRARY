...
public class Numbers {
	 ...
	 * MINIMUM_EQUAL, the sign is considered 0, if both are positive or both are negative, the
	 * sign is 1, that is, both follow the same direction, while otherwise, when one is positive and
	 * the other is negative, the sign is -1, indicating that they follow fifferent directions.
